...
### Assignment Task
The management team at Nosto is interested in predicting how long it takes for a customer to return to the webshop 
after their last visit, based on their previous shopping behavior. Your task is to predict this return time. 
In addition, please explore and analyze the dataset to uncover any relevant insights or patterns that could inform business decisions.
