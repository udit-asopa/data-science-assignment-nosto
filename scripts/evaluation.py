...
def print_leaderboard(
	...
	header = (
		f"  {'Model':<{col_w}} {'MAE (h)':>9} {'RMSE (h)':>10} {'vs Baseline':>13}"
	)
	print(header)
	print("  " + "─" * (col_w + 35))
